...
Executes activities and returns results
"""
    ...
    if not activities:
        ...
        <main class="main-content">
            <div class="error-box">
                ...
                <a href="activities.cgi" class="btn btn-primary">Go Back</a>
            </div>
        </main>
"""
    else:
...
"""
        ...
        for activity_num in activities:
            ...
            if errors:
                ...
                for error in errors:
                    ...
                    escaped_error = cgi.escape(str(error)).replace('\n', '<br>')
                ...
                for result in results:
                    # Escape HTML and preserve formatting
                    escaped_result = cgi.escape(str(result)).replace('\n', '<br>')
        ...
        html += """
            ...
            <div class="form-actions">
                <a href="activities.cgi" class="btn btn-primary">Run More Activities</a>
                <a href="index.cgi" class="btn btn-secondary">Home</a>
            </div>
        </main>
"""
